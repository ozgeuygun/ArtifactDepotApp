...
{
    public class EfExcavationSiteDal : GenericRepository<ExcavationSite>, IExcavationSiteDal
    {
        public EfExcavationSiteDal(ArtifactContext artifactContext) : base(artifactContext)
        {
        }
    }
}
